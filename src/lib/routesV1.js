...
//     layouts?: LazyExoticComponent<ComponentType<any>>[];
// }
// const routeConfig = {
...
//     // Create a lazy-loaded component and wrap it with ErrorBoundary
//     const component = lazy(importPages[path] as any);
//     const WrappedComponent = withErrorBoundary(component, <div>Failed to load the page < /div>);
//   // Check if the file is a layout component
//   if (currentEnd === 'layout') {
//         layouts[basePath] = layouts[basePath] || [];
//         layouts[basePath].push(WrappedComponent);
...
//     return { path: basePath === '__ROOT__' ? '/' : basePath, component: WrappedComponent, layout };
